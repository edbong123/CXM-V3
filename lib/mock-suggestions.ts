...
const suggestions: Suggestion[] = [
  // BUSINESS-CONTEXT.md
  {
    ...
    type: "change",
    summary: "Narrow the target customer segment to a specific ICP.",
    detail:
  ...
  },
  {
    ...
    fileId: "BUSINESS-CONTEXT.md",
    type: "addition",
    summary: "Add a competitive landscape section with key differentiators.",
    detail:
  ...
  },
  {
    ...
    fileId: "BUSINESS-CONTEXT.md",
    type: "clarification",
    summary: "Define measurable success metrics and KPIs.",
    detail:
  ...
  },
  {
    ...
    fileId: "BUSINESS-CONTEXT.md",
    type: "change",
    summary: "Sharpen the opening value proposition statement.",
    detail:
  ...
  // TECH-STACK.md
  {
    ...
    type: "change",
    summary: "Document the rationale for each technology choice.",
    detail:
  ...
  },
  {
    ...
    fileId: "TECH-STACK.md",
    type: "addition",
    summary: "Add an ADR for state management approach.",
    detail:
  ...
  },
  {
    ...
    fileId: "TECH-STACK.md",
    type: "clarification",
    summary: "Specify deployment environment and secrets requirements.",
    detail:
  ...
  },
  {
    ...
    fileId: "TECH-STACK.md",
    type: "addition",
    summary: "Add a testing strategy section with coverage targets.",
    detail:
  ...
  // README.md
  {
    ...
    fileId: "README.md",
    type: "change",
    summary: "Add a quick-start section with prerequisites.",
    detail:
  ...
  },
  {
    ...
    fileId: "README.md",
    type: "addition",
    summary: "Add contributing guidelines for new contributors.",
    detail:
